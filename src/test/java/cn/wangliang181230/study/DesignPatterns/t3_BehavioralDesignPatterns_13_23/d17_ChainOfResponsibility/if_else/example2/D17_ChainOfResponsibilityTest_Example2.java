...
@SpringBootTest
class D17_ChainOfResponsibilityTest_Example2 {
	...
	public void test10() {
		Assertions.assertThrows(IllegalArgumentException.class, () -> {
			try {
				businessService2.doBusiness("11111", null, 18, "老年人");
	...
	public void test21() {
		Assertions.assertThrows(IllegalArgumentException.class, () -> {
			try {
				businessService2.doBusiness("22222", "userId_222", null, "老年人");
			} catch (IllegalArgumentException e) {
	...
	public void test22() {
		Assertions.assertThrows(IllegalArgumentException.class, () -> {
			try {
				businessService2.doBusiness("22222", "userId_222", 17, "老年人");
			} catch (IllegalArgumentException e) {
	...
	public void test31() {
		Assertions.assertThrows(IllegalArgumentException.class, () -> {
			try {
				businessService2.doBusiness("33333", "userId_333", 18, null);
			} catch (IllegalArgumentException e) {
	...
	public void test32() {
		Assertions.assertThrows(IllegalArgumentException.class, () -> {
			try {
				businessService2.doBusiness("33333", "userId_333", 18, "病人");
			} catch (IllegalArgumentException e) {
	...
	public void testSuccess() {
		businessService2.doBusiness("44444", "userId_444", 18, "老年人");
	}
}
